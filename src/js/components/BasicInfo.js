...
class BasicInfo extends React.Component {
    ...
    render() {
        ...
        let bInfo = this.makedata();
        return (
            <div className="d-flex flex-column justify-content-center align-items-center">
                <div className="row w-75">
                    <div className="col-md-2 d-flex justify-content-center">
                        <img src={bInfo.front_image} />
                        <img src={bInfo.back_image} />
                    </div>
                    <div className="col-md-5 d-flex justify-content-center flex-column">
                        <p className="h3 mr-3 text-center">No.{bInfo.pokedexNo}</p>
                        <p className="h2 text-center">{bInfo.name}</p>
                    ...
                    <div className="col-md-5 d-flex justify-content-center flex-column align-item-center">
                            <div className="d-flex justify-content-center">
                                <p className="mr-1">{bInfo.weight}</p>
                                <p className="ml-1">{bInfo.height}</p>
                            </div>
                            <p className="text-center">{bInfo.genus}</p>
                    </div>
                </div>
